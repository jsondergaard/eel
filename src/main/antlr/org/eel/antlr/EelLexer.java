...
public class EelLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LET", "BEGINPROCEDURE", "ENDPROCEDURE", "RETURN", "REPEATWHILE", "ENDREPEAT", 
			"IF", "ENDIF", "THEN", "ELSE", "PRINT", "INTLIT", "STRINGLIT", "DECLIT", 
			"PLUS", "MINUS", "ASTERISK", "DIVISION", "ASSIGN", "LPAREN", "RPAREN", 
			"COMMA", "GREATERTHAN", "LESSTHAN", "FUNCTIONS", "METHODS", "BOOLEANOPERATOR", 
			"WS", "ID"
		};
	}
	...
	@Override
	public String getGrammarFileName() { return "EelLexer.g4"; }
